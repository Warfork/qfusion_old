...
static void DownloadCallback( void *self )
{
	...
	{
		trap_Cvar_SetValue("allow_download", f->curvalue);
	}

	else if (f == &s_allow_download_maps_box)
	{
		trap_Cvar_SetValue("allow_download_maps", f->curvalue);
	}

	else if (f == &s_allow_download_models_box)
	{
		trap_Cvar_SetValue("allow_download_models", f->curvalue);
	}

	else if (f == &s_allow_download_players_box)
	{
		trap_Cvar_SetValue("allow_download_players", f->curvalue);
	}

	else if (f == &s_allow_download_sounds_box)
	{
		trap_Cvar_SetValue("allow_download_sounds", f->curvalue);
	}
}
...
void DownloadOptions_MenuInit( void )
{
	...
	s_allow_download_box.generic.y	= y += y_offset*2;
	...
	s_allow_download_maps_box.generic.y	= y += y_offset*2;
	...
	s_allow_download_players_box.generic.y	= y += y_offset;
	...
	s_allow_download_models_box.generic.y	= y += y_offset;
	...
	s_allow_download_sounds_box.generic.y	= y += y_offset;
