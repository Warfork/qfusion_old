...
# ADD LINK32 kernel32.lib user32.lib winmm.lib /nologo /dll /machine:I386 /out:"..\release\cgame_x86.dll"
...
# ADD LINK32 kernel32.lib user32.lib winmm.lib /nologo /dll /incremental:no /map /debug /machine:I386 /out:"..\debug\cgame_x86.dll" /pdbtype:sept
