...
#define	MZ_GRENADE			8
#define	MZ_BFG				9
#define	MZ_SSHOTGUN			10
#define	MZ_HYPERBLASTER		11
#define	MZ_ITEMRESPAWN		12
...
typedef enum
{
	...
	TE_PLAYER_TELEPORT_IN,
	TE_PLAYER_TELEPORT_OUT,

	TE_LIGHTNING,

	TE_INVERSE		= 128	// bit ORed flag used with one of the above numbers
} temp_event_t;
