...
void gib_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
{
	...
	if (plane)
	{
		G_Sound (self, CHAN_VOICE, trap_SoundIndex ("sound/misc/fhit3.wav"), 1, ATTN_NORM);
...
void ThrowDebris (edict_t *self, char *modelname, float speed, vec3_t origin)
{
	...
	chunk->s.modelindex = trap_ModelIndex (modelname);
	v[0] = 100 * crandom();
	v[1] = 100 * crandom();
	v[2] = 100 + 100 * crandom();
...
//ZOID
	...
	G_TurnEntityIntoEvent ( self, EV_EXPLOSION1, 0 );
}
...
void path_corner_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
{
	vec3_t		v;
	edict_t		*next;
...
*/
void point_combat_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
{
	edict_t	*activator;
	...
	if (self->pathtarget)
	{
		...
		savetarget = self->target;
		self->target = self->pathtarget;
		if (other->enemy && other->enemy->r.client)
			activator = other->enemy;
		else if (other->oldenemy && other->oldenemy->r.client)
			activator = other->oldenemy;
		else if (other->activator && other->activator->r.client)
...
//	ent->s.modelindex = trap_ModelIndex ("models/player_y/tris.md2");
	ent->s.modelindex = trap_ModelIndex ("models/objects/banner/tris.md2");
	trap_LinkEntity (ent);
...
void func_object_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
{
...
void barrel_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
...
void SP_misc_explobox (edict_t *self)
{
	...
	trap_ModelIndex ("models/objects/debris1/tris.md2");
	trap_ModelIndex ("models/objects/debris2/tris.md2");
	trap_ModelIndex ("models/objects/debris3/tris.md2");
...
void SP_misc_blackhole (edict_t *ent)
{
	...
	ent->s.modelindex = trap_ModelIndex ("models/objects/black/tris.md2");
...
void SP_misc_eastertank (edict_t *ent)
{
	...
	ent->s.modelindex = trap_ModelIndex ("models/monsters/tank/tris.md2");
	ent->s.frame = 254;
...
void SP_misc_easterchick (edict_t *ent)
{
	...
	VectorSet (ent->r.maxs, 32, 32, 32);
	ent->s.modelindex = trap_ModelIndex ("models/monsters/bitch/tris.md2");
	ent->s.frame = 208;
...
void commander_body_think (edict_t *self)
{
	...
	if (self->s.frame == 22)
		G_Sound (self, CHAN_BODY, trap_SoundIndex ("sound/tank/thud.wav"), 1, ATTN_NORM);
}
...
void commander_body_use (edict_t *self, edict_t *other, edict_t *activator)
{
	...
	self->nextthink = level.time + FRAMETIME;
	G_Sound (self, CHAN_BODY, trap_SoundIndex ("sound/tank/pain.wav"), 1, ATTN_NORM);
}
...
void SP_monster_commander_body (edict_t *self)
{
	...
	trap_SoundIndex ("sound/tank/thud.wav");
	trap_SoundIndex ("sound/tank/pain.wav");
...
void SP_misc_deadsoldier (edict_t *ent)
{
	...
	ent->movetype = MOVETYPE_NONE;
	ent->r.solid = SOLID_BBOX;
	ent->s.modelindex = trap_ModelIndex ("models/deadbods/dude/tris.md2");
...
void SP_misc_viper (edict_t *ent)
{
	...
	ent->r.solid = SOLID_NOT;
	ent->s.modelindex = trap_ModelIndex ("models/ships/viper/tris.md2");
	VectorSet (ent->r.mins, -16, -16, 0);
	VectorSet (ent->r.maxs, 16, 16, 32);
...
void SP_misc_bigviper (edict_t *ent)
{
	...
	ent->s.modelindex = trap_ModelIndex ("models/ships/bigviper/tris.md2");
	trap_LinkEntity (ent);
}
...
*/
void misc_viper_bomb_touch (edict_t *self, edict_t *other, cplane_t *plane, int surfFlags)
{
...
void SP_misc_viper_bomb (edict_t *self)
{
	...
	self->s.modelindex = trap_ModelIndex ("models/objects/bomb/tris.md2");
...
void SP_misc_strogg_ship (edict_t *ent)
{
	...
	ent->movetype = MOVETYPE_PUSH;
	ent->r.solid = SOLID_NOT;
	ent->s.modelindex = trap_ModelIndex ("models/ships/strogg1/tris.md2");
	VectorSet (ent->r.mins, -16, -16, 0);
	VectorSet (ent->r.maxs, 16, 16, 32);
...
void SP_misc_satellite_dish (edict_t *ent)
{
	...
	ent->s.modelindex = trap_ModelIndex ("models/objects/satellite/tris.md2");
...
void SP_light_mine2 (edict_t *ent)
{
	ent->movetype = MOVETYPE_NONE;
	ent->r.solid = SOLID_BBOX;
	ent->s.modelindex = trap_ModelIndex ("models/objects/minelite/light2/tris.md2");
	trap_LinkEntity (ent);
}
...
void SP_func_clock (edict_t *self)
{
	...
	self->message = G_LevelMalloc (CLOCK_MESSAGE_SIZE);
