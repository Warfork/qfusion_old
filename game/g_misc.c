...
void gib_touch (edict_t *self, edict_t *other, cplane_t *plane, csurface_t *surf)
{
	...
	if (plane)
	{
		gi.sound (self, CHAN_VOICE, gi.soundindex ("sound/misc/fhit3.wav"), 1, ATTN_NORM, 0);
...
void commander_body_think (edict_t *self)
{
	...
	if (self->s.frame == 22)
		gi.sound (self, CHAN_BODY, gi.soundindex ("sound/tank/thud.wav"), 1, ATTN_NORM, 0);
}
...
void commander_body_use (edict_t *self, edict_t *other, edict_t *activator)
{
	...
	self->nextthink = level.time + FRAMETIME;
	gi.sound (self, CHAN_BODY, gi.soundindex ("sound/tank/pain.wav"), 1, ATTN_NORM, 0);
}
...
void SP_monster_commander_body (edict_t *self)
{
	...
	gi.soundindex ("sound/tank/thud.wav");
	gi.soundindex ("sound/tank/pain.wav");
...
void misc_deadsoldier_die (edict_t *self, edict_t *inflictor, edict_t *attacker, int damage, vec3_t point)
{
	...
	gi.sound (self, CHAN_BODY, gi.soundindex ("sound/misc/udeath.wav"), 1, ATTN_NORM, 0);
	for (n= 0; n < 4; n++)
...
void SP_misc_deadsoldier (edict_t *ent)
{
	...
	ent->svflags |= SVF_MONSTER|SVF_CORPSE;
