...
void SCR_PlayCinematic (char *arg)
{
	...
	cin.width = LittleLong(minfo.width);
	cin.height = LittleLong(minfo.height);
	cin.s_rate = LittleLong(minfo.s_rate);
	cin.s_width = LittleLong(minfo.s_width);
	cin.s_channels = LittleLong(minfo.s_channels);
