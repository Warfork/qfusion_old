...
static void R_FinalizeGLExtensions( void )
{
	...
	Cvar_Get( "gl_max_texture_size", "0", CVAR_NOSET );
	...
	Cvar_Get( "gl_ext_texture_filter_anisotropic_max", "0", CVAR_NOSET );
	...
	clamp( glConfig.curTextureFilterAnisotropic, 0, glConfig.maxTextureFilterAnisotropic );
}
...
void R_Register( void )
{
	...
	r_portalmaps_maxtexsize = Cvar_Get( "r_portalmaps_maxtexsize", "800", CVAR_ARCHIVE );
	...
	r_occlusion_queries = Cvar_Get( "r_occlusion_queries", "2", CVAR_ARCHIVE );
	...
	r_shadows_maxtexsize = Cvar_Get( "r_shadows_maxtexsize", "0", CVAR_ARCHIVE );
